...
import com.example.cameratest.cameraview.Audio;
import com.example.cameratest.cameraview.CameraOptions;
import com.example.cameratest.cameraview.CameraView;
import com.example.cameratest.cameraview.Flash;
import com.example.cameratest.cameraview.Gesture;
import com.example.cameratest.cameraview.GestureAction;
import com.example.cameratest.cameraview.Grid;
import com.example.cameratest.cameraview.Hdr;
import com.example.cameratest.cameraview.Mode;
import com.example.cameratest.cameraview.VideoCodec;
import com.example.cameratest.cameraview.WhiteBalance;
...
public enum Control {
    ...
    public Collection<?> getValues(CameraView view, @NonNull CameraOptions options) {
        switch (this) {
            ...
            case HEIGHT:
                ...
                return list;
            case MODE:
                return options.getSupportedControls(Mode.class);
            case FLASH:
            ...
            case VIDEO_CODEC:
                return options.getSupportedControls(VideoCodec.class);
            case PINCH:
            case HSCROLL:
            case VSCROLL:
    ...
    public Object getCurrentValue(CameraView view) {
        switch (this) {
            ...
            case GRID:
                return view.getGrid();
            case GRID_COLOR:
                return new GridColor(view.getGridColor(), "color");
            case AUDIO:
                return view.getAudio();
            case VIDEO_CODEC:
                return view.getVideoCodec();
            case HDR:
                return view.getHdr();
            case PINCH:
    ...
    public void applyValue(CameraView camera, Object value) {
        switch (this) {
            ...
            case VIDEO_CODEC:
            case HDR:
                camera.set((com.example.cameratest.cameraview.Control) value);
                break;
            case PINCH:
